      ...
      <form onSubmit={handleSubmit(onCreateEvent)}>
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    ...
                    />
                    {errors.start_date && (
                      <p className='alert'>{errors.start_date?.message?.toString()}</p>
                    )}
                  </LocalizationProvider>
                )}
              />
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    ...
                    />
                    {errors.end_date && (
                      <p className='alert'>{errors.end_date?.message?.toString()}</p>
                    )}
                  </LocalizationProvider>
                )}
              />
        ...
        {currentStep === 2 && (
          <Stack spacing={2}>
            ...
            <span className='select-location'>Lokasyon seçimi için çift tıklayınız</span>
