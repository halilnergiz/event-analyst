...
export const PasswordReset = () => {
    ...
    return (
        <div className='reset-password-container'>
            ...
            <form className='reset-password-form' onSubmit={handleSubmit(onPasswordReset)} autoComplete='off'>
                <div className='title'>
                ...
                <div className='form-field new-password-repeat'>
                    ...
                    />
                    {errors.new_password_repeat?.message && <p className='alert'> {errors.new_password_repeat?.message}</p>}
                    <Button type='submit' color='success'>Onayla</Button>
                </div>
            </form>
        </div>
    );
