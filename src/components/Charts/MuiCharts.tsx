  ...
  return !participiants ? (
    ...
    <div className='age-infs'>
      <div className='infs'>
        ...
        <span>18 Yaş Altı: {participiants[0]} Kişi</span>
      </div>
      <div className='infs'>
        <div className='inf-box id-1' />
        <span>18-25 Yaş: {participiants[1]} Kişi</span>
      </div>
      <div className='infs'>
        <div className='inf-box id-2' />
        <span>26-35 Yaş: {participiants[2]} Kişi</span>
      </div>
      <div className='infs'>
        <div className='inf-box id-3' />
        <span>36-45 Yaş: {participiants[3]} Kişi</span>
      </div>
      <div className='infs'>
        <div className='inf-box id-4' />
        <span>46-60 Yaş: {participiants[4]} Kişi</span>
      </div>
      <div className='infs'>
        <div className='inf-box id-5' />
        <span>60 Yaş Üzeri: {participiants[5]} Kişi</span>
      </div>
    </div>
  );
};
