...
export const createEventSchema = yup.object({
  title: yup.string().max(200, 'En fazla 200 karakter').required('Zorunlu alan'),
  description: yup.string().max(500, 'En fazla 500 karakter'),
  address: yup.string().max(200, 'En fazla 200 karakter'),
  longitude: onlyNumberOrEmtyString,
  latitude: onlyNumberOrEmtyString,
  start_date: yup.date<dayjs.Dayjs | null | any>().nullable(),
  end_date: yup
